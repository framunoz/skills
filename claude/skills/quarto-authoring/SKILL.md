...
description: Core syntax, formatting, and authoring for Quarto documents (.qmd). Use when writing, styling, and organizing figures, tables, and cross-references in standard documents.
---
