...
description: Migrate legacy R Markdown projects (blogdown, bookdown, distill, xaringan) to Quarto. Use when converting .Rmd files or existing project structures to Quarto-compatible formats.
---
