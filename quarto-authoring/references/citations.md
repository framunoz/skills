...
* [Citation Syntax](#citation-syntax)
  * [Basic Citations](#basic-citations)
  * [Variations](#variations)
  * [Multiple Citations](#multiple-citations)
  * [Citation with Locators](#citation-with-locators)
  * [In-Text vs Parenthetical](#in-text-vs-parenthetical)
  * [Prefix and Suffix](#prefix-and-suffix)
* [Bibliography Configuration](#bibliography-configuration)
  * [Basic Setup](#basic-setup)
  * [Multiple Files](#multiple-files)
  * [BibTeX File Example](#bibtex-file-example)
  * [Other Formats](#other-formats)
* [Citation Styles (CSL)](#citation-styles-csl)
  * [Specify CSL File](#specify-csl-file)
  * [Find CSL Files](#find-csl-files)
...
* [Footnotes](#footnotes)
  ...
  * [Multi-Paragraph Footnotes](#multi-paragraph-footnotes)
* [Citation Methods](#citation-methods)
  * [Citeproc (Default)](#citeproc-default)
  * [BibLaTeX (PDF)](#biblatex-pdf)
  * [Natbib (PDF)](#natbib-pdf)
* [Reference Section Title](#reference-section-title)
* [Citation Links](#citation-links)
* [Citation Processing Options](#citation-processing-options)
* [DOI and URL Handling](#doi-and-url-handling)
* [Footnote Location](#footnote-location)
* [Citation Hover (HTML)](#citation-hover-html)
* [Author-Date vs Numeric](#author-date-vs-numeric)
* [Citing Software](#citing-software)
* [Citation Tools Integration](#citation-tools-integration)
  * [Zotero](#zotero)
