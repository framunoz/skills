...
This is a manually maintained checklist of Mermaid diagram types from the [official syntax reference index](https://mermaid.js.org/intro/syntax-reference.html). A checked item has a focused skill reference and router registration; an unchecked item awaits both. To register a type, follow the router's [Adding a type](router.md#adding-a-type) workflow, then change its checkbox.
...
- [ ] [Entity Relationship diagram](https://mermaid.js.org/syntax/entityRelationshipDiagram.html) (Experimental)
...
- [ ] [Radar chart](https://mermaid.js.org/syntax/radar.html) (Beta)
- [ ] [Treemap](https://mermaid.js.org/syntax/treemap.html) (Beta)
- [ ] [Sankey diagram](https://mermaid.js.org/syntax/sankey.html) (Beta)
- [ ] [Venn diagram](https://mermaid.js.org/syntax/venn.html) (Beta)
...
- [x] [ZenUML sequence diagram](https://mermaid.js.org/syntax/zenuml.html) ([skill reference](zenuml.md))
