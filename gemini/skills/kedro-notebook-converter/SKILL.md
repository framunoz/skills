...
description:
  Strict workflow for converting Jupyter Notebooks (.ipynb) or .qmd scripts
  into Kedro pipelines. Use this skill whenever the user explicitly asks to convert,
  migrate, or translate a notebook into Kedro nodes, pipelines, and a data catalog.
  Do NOT use this skill for general Kedro project creation unless notebooks are involved.
metadata:
